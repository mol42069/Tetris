...
def main():
    ...
    while running:
        ...
        for event in pygame.event.get():                                          # and we use match|case on the events
            if event.type == pygame.QUIT:
                return
            elif event.type ==  pygame.KEYDOWN:                                    # we see if a key is pressed down
                # MOVEMENT input
                ...
                elif event.key == pygame.K_w:                                # rotate right
                    last_dir = True
                    if direction[0] < 3:
                        direction[0] += 1
                    else:
                        direction[0] = 0
                elif event.key == pygame.K_s:                                # rotate left
                    last_dir = False
                    if direction[0] == 0:
                        direction[0] -= 1
                    else:
                        direction[0] = 3
                elif event.key == pygame.K_SPACE:                            # fast down
                    delay = 0.03
            elif event.type == pygame.KEYUP:                                      # we see if a key is unpressed
