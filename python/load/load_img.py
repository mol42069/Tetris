...
def load():
    ...
    img = [
        ...
        pygame.image.load('./resources/Screens/Leaderboard.png'),               # 27
        pygame.image.load('./resources/Buttons/back.png'),                      # 28
        pygame.image.load('./resources/Buttons/back_hover.png'),                # 29
        pygame.image.load('./resources/Buttons/back_clicked.png'),              # 30
        pygame.image.load('./resources/Screens/leaderboard_enter.png'),         # 31
        pygame.image.load('./resources/Buttons/submit.png'),                    # 32
        pygame.image.load('./resources/Buttons/submit_hover.png'),              # 33
        pygame.image.load('./resources/Buttons/submit_clicked.png'),            # 34
